...
![メイン基板サイドキーパッド基板取り付け](img/main_side_board/main_side_board.jpg)
ジャンパワイヤを7本基板表側から差し込みます．
![メイン基板サイドキーパッド基板配線](img/main_side_board/main_side_board.jpg)
この状態でマスキングテープ等で固定します．
![メイン基板サイドキーパッド基板配線](img/main_side_board/main_side_board_cable.jpg)
メイン基板とサイドキーパッド基板を外し，はんだ付け用治具1,2に取り付けます．
![メイン基板サイドキーパッド基板配線](img/main_side_board/main_side_board_jig.jpg)
基板の裏側からジャンパワイヤをはんだ付けします．
![メイン基板サイドキーパッド基板配線](img/main_side_board/main_side_board_back.jpg)
余分なジャンパワイヤを切断します．
![メイン基板サイドキーパッド基板配線](img/main_side_board/main_side_board_cut.jpg)
## [組み立て]
